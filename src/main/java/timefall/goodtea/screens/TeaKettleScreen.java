...
import timefall.goodtea.utils.MouseUtil;
...
public class TeaKettleScreen extends HandledScreen<TeaKettleScreenHandler> {
    ...
    protected void drawForeground(MatrixStack matrices, int mouseX, int mouseY) {
        ...
        renderWaterTooltip(matrices, mouseX, mouseY, x, y, handler.fluidStack, 55, 15, fluidStackRenderer);
    }

    private void renderWaterTooltip(MatrixStack matrices, int mouseX, int mouseY, int x, int y,
    ...
    protected void drawBackground(MatrixStack matrices, float delta, int mouseX, int mouseY) {
        ...
        fluidStackRenderer.drawFluid(matrices, handler.fluidStack, x + 83, y + 15, 16, 34,
