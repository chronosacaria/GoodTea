...
public class TeaKettleBlockEntity extends BlockEntity implements NamedScreenHandlerFactory, IImplementedInventory {
    ...
    private static void craftItem(TeaKettleBlockEntity entity) {
        ...
        if (!itemStack.isEmpty() && canInsertAmountIntoOutputSlot(inventory)
            ...
            entity.setStack(numberOfSlotsInTeaKettle - 1, new ItemStack(itemStack.getItem(),
    ...
    private static boolean canInsertItemIntoOutputSlot(SimpleInventory inventory, Item output) {
        return inventory.getStack(numberOfSlotsInTeaKettle - 1).getItem()
                == output || inventory.getStack(numberOfSlotsInTeaKettle - 1).isEmpty();
    }

    private static boolean canInsertAmountIntoOutputSlot(SimpleInventory inventory) {
        return inventory.getStack(numberOfSlotsInTeaKettle - 1).getMaxCount()
                > inventory.getStack(numberOfSlotsInTeaKettle - 1).getCount();
    }
